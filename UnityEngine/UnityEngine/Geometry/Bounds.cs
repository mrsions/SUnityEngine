...
namespace UnityEngine
{
    ...
    public partial struct Bounds : IEquatable<Bounds>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        [Obsolete("Not Support. please make extern code.", true)] public bool IntersectRay(Ray ray) { float dist; return IntersectRayAABB(ray, this, out dist); }
        [MethodImpl(MethodImplOptionsEx.AggressiveInlining)]
        [Obsolete("Not Support. please make extern code.", true)] public bool IntersectRay(Ray ray, out float distance) { return IntersectRayAABB(ray, this, out distance); }

...
namespace UnityEngine.Rendering
{
    ...
    public struct SphericalHarmonicsL2 : IEquatable<SphericalHarmonicsL2>
    {
        ...
        [Obsolete("Not Support. please make extern code.", true)] private void SetZero() { }

        [Obsolete("Not Support. please make extern code.", true)] public void AddAmbientLight(Color color) { }
        ...
        [FreeFunction]
        [Obsolete("Not Support. please make extern code.", true)] private static void AddDirectionalLightInternal(ref SphericalHarmonicsL2 sh, Vector3 direction, Color color) { }
        ...
        [FreeFunction]
        [Obsolete("Not Support. please make extern code.", true)] private static void EvaluateInternal(ref SphericalHarmonicsL2 sh, Vector3[] directions, [Out] Color[] results) { }
